...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        return new Task().text(DEFAULT_TEXT).answer(DEFAULT_ANSWER).title(DEFAULT_TITLE);
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        return new Task().text(UPDATED_TEXT).answer(UPDATED_ANSWER).title(UPDATED_TITLE);
    }
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.answer").value(DEFAULT_TITLE));
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.text(UPDATED_TEXT).answer(UPDATED_ANSWER);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.text(UPDATED_TEXT).answer(UPDATED_ANSWER);
