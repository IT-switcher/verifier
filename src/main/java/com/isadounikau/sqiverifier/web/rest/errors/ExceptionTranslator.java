...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.isadounikau.sqiverifier.service.EmailAlreadyUsedException ||
            ex instanceof com.isadounikau.sqiverifier.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.isadounikau.sqiverifier.service.InvalidPasswordException
